              ...
              <div class="swpm-login-form-inner">
                ...
                <div class="row">
                  <div class="swpm-forgot-pass-link columns shrink">
                    <a id="forgot_pass" class="swpm-login-form-pw-reset-link" href="http://localhost:8888/HAPPYS/golf/wp/sign-in/password-reset/">Forgot Password?</a>
                  </div>
                  <div class="swpm-join-us-link columns shrink">
                    <a id="register" class="swpm-login-form-register-link" href="http://localhost:8888/HAPPYS/golf/wp/sign-up">Join Us</a>
                  </div>
                </div>
