    ...
    <form id="swpm-registration-form" name="swpm-registration-form" method="post" action="">
        ...
        <table>
            <tr class="swpm-registration-username-row">
                <td><label for="user_name"><?php echo SwpmUtils::_('ユーザー名') ?></label></td>
            ...
            <tr class="swpm-registration-email-row">
                <td><label for="email"><?php echo SwpmUtils::_('ユーザー名') ?></label></td>
            ...
            <tr class="swpm-registration-password-row">
                <td><label for="password"><?php echo SwpmUtils::_('パスワード') ?></label></td>
            ...
            <tr class="swpm-registration-password-retype-row">
                <td><label for="password_re"><?php echo SwpmUtils::_('パスワード（確認）') ?></label></td>
            ...
            <tr class="swpm-registration-firstname-row">
                <td><label for="first_name"><?php echo SwpmUtils::_('名前') ?></label></td>
            ...
            <tr class="swpm-registration-lastname-row">
                <td><label for="last_name"><?php echo SwpmUtils::_('苗字') ?></label></td>
